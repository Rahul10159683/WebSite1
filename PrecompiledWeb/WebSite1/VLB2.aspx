<%@ page language="C#" autoeventwireup="true" inherits="VLB2, App_Web_5ozjgadu" %>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="#">Enrollment to PM Schemes</a>
  ...
  <div class="container-fluid m-body m-body-leaderboard">
    <div class="m-sq-box">
    <a style="font-weight: bold; font-size: larger">REGION LEVEL RANKING</a>  
    </div>
