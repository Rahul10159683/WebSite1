...
function activeData(id) {
    ...
    const posb = document.getElementsByClassName('bosb');
    const buttonbosb = document.getElementsByClassName('buttonbosb');
    for (i = 0; i < posb.length; i++) {
        bosb[i].classList.remove('active');
    }
    for (i = 0; i < buttonposb.length; i++) {
        buttonposb[i].classList.remove('active');
    }
   
    if (bosb_overall.classList.contains('active')) {
...
function activeBOData(id) {
    const findid = document.getElementsByClassName(id);
    const buttonid = document.getElementById(id);
    const bosb = document.getElementsByClassName('bosb');
    const buttonposb = document.getElementsByClassName('buttonposb');
    for (i = 0; i < bosb.length; i++) {
        bosb[i].classList.remove('active');
    }
    for (i = 0; i < buttonposb.length; i++) {
        buttonposb[i].classList.remove('active');
